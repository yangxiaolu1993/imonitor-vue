  ...
  <div class="monitorCustomization">
    <div class="choose">
      ...
      <div class=" choose-item-box">
        <chooseOptionList :listData="itemData"/>
      </div>
      <div class="show-choose-platform">
        <div class="has-choose title">已选平台:
          <span v-for="item in AllItemData" v-if="item.choose">{{item.name}}
                      <i class="fa fa-times"/>
         </span>
        </div>
    ...
    mounted() {
      ...
      for (var i = 0; i < this.itemData.length; i++) {
        for (var j = 0; j < this.itemData[i].items.length; j++) {
          this.AllItemData[index] = this.itemData[i].items[j];
          index++;
        }
      }
    }
...
<style scoped>
  @import '../../assets/css/monitorCustomization/monitorCustomization.css';
