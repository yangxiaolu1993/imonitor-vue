  ...
  export default {
    ...
    methods: {
      ...
      setupOptions() {
        ...
        return {
          title: {text: '传播路径', top: "20", left: "30"},
      ...
      setupSeries() {
        return [{
          ...
          //全局设置文字属性
          label: {color: '#444444', position: 'inside', show: false, fontStyle: 'oblique'},
          //全局设置是否可拖动
          draggable: true,
          //全局设置连接线属性
          lineStyle: {type: 'solid', color: 'D0D0D0', opacity: 0.1, curveness: 0.2},
          //
