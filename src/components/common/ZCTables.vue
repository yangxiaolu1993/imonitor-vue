<template>
  ...
  <div class="zctables" style="background-color: white">
    ...
    <div id="zctables_content" style="overflow: auto">
      <el-table :data="data?data:null"
                :header-cell-style="options.headerStyle?headerCellStyle:null"
                :cell-style="options.columnStyle?cellStyle:null"
                :border="options.showBorder?options.showBorder:false"
                :show-header="options.showHeader?options.showHeader:true"
    ...
    <!--分页控制器部分-->
    <div class="zctables_page" v-if="data.length&&data.length<options.total">
  ...
  export default {
    ...
    methods: {
      ...
      cellStyle({row, column, rowIndex, columnIndex}) {
        ...
        column.columnIndex = (this.options.tableType && this.options.tableType.position == 'leading') ? columnIndex - 1 : columnIndex;
